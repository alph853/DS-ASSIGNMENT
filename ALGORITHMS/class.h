...
public:
   ...
   // read files
   void loadRoad(const std::string &roadFile);
   void loadNode(const std::string &nodeFile);
   ...
   matrix<double> get_bearing() const { return m_bearing; }
...
public:
   ...
   {
      loadNode("nodeFile.csv");
      loadRoad("roadFile.csv");
   }

   void loadRoad(const std::string &roadFile) const;
   void loadNode(const std::string &nodeFile) const;
   ...
   matrix<double> get_bearing() const { return m_nodeManager->get_bearing(); }
